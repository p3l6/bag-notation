...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note, 1, .production_id = 2),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note, 1, .production_id = 2),
  [165] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note, 2, .production_id = 4),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note, 2, .production_id = 4),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note, 3, .production_id = 6),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note, 3, .production_id = 6),
  ...
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note, 2, .production_id = 3),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note, 2, .production_id = 3),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_literal_embellishment_repeat1, 2),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_literal_embellishment_repeat1, 2), SHIFT_REPEAT(40),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 1, .production_id = 1),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [210] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_header_repeat1, 2),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tune, 2),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 3, .production_id = 5),
  ...
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_embellishment, 3),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [238] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tail_comment, 2),
