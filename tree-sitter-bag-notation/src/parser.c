...
enum {
  ...
  aux_sym_voice_repeat1 = 33,
  aux_sym_header_repeat1 = 34,
  aux_sym_bar_repeat1 = 35,
  aux_sym_cluster_repeat1 = 36,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_voice] = STATE(4),
    [sym_inline_field] = STATE(11),
    [sym_bar] = STATE(5),
    [sym__bar_content] = STATE(13),
    [sym_cluster] = STATE(13),
    [sym_note] = STATE(32),
    [sym__blank_line] = STATE(4),
    [sym_comment] = STATE(4),
    [aux_sym_voice_repeat1] = STATE(5),
    [aux_sym_bar_repeat1] = STATE(13),
    [aux_sym_cluster_repeat1] = STATE(32),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_voice_repeat1, 2), SHIFT_REPEAT(41),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_voice_repeat1, 2), SHIFT_REPEAT(23),
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_voice_repeat1, 2), SHIFT_REPEAT(53),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_voice_repeat1, 2), SHIFT_REPEAT(34),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bar, 1),
  [71] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bar_repeat1, 2), SHIFT_REPEAT(41),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_bar_repeat1, 2),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bar_repeat1, 2), SHIFT_REPEAT(53),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bar_repeat1, 2), SHIFT_REPEAT(34),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_voice, 2),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_voice, 5),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_voice, 3),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_voice, 4),
  ...
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_cluster_repeat1, 2),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_cluster_repeat1, 2), SHIFT_REPEAT(53),
  [117] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_cluster_repeat1, 2), SHIFT_REPEAT(34),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_field, 3),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cluster, 2),
