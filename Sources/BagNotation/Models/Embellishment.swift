...
private func pitchesFor(_ emb: EmbellishmentType, from: Pitch, on pitch: Pitch) throws -> [Pitch] {
    ...
    case let (.doubling(half), from, .highG): (half || from == .highA) ? [.highG, .highA] : [.highG, .f]
    case let (.doubling(half), from, .f): (half || from == .highA) ? [.f, .highG] : [from == .highG ? .highA : .highG, .f, .highG]
    case let (.doubling(half), from, .e): (half || from == .highA) ? [.e, .f] : [from == .highG ? .highA : .highG, .e, .f]
    case let (.doubling(half), from, .d): (half || from == .highA) ? [.d, .e] : [from == .highG ? .highA : .highG, .d, .e]
    case let (.doubling(half), from, .c): (half || from == .highA) ? [.c, .d] : [from == .highG ? .highA : .highG, .c, .d]
    case let (.doubling(half), from, .b): (half || from == .highA) ? [.b, .d] : [from == .highG ? .highA : .highG, .b, .d]
    case let (.doubling(half), from, .lowA): (half || from == .highA) ? [.lowA, .d] : [from == .highG ? .highA : .highG, .lowA, .d]
    case let (.doubling(half), from, .lowG): (half || from == .highA) ? [.lowG, .d] : [from == .highG ? .highA : .highG, .lowG, .d]
    // grips
